from .array.clip import clip
from .array.error_nan import error_nan
from .array.guess_type import guess_type
from .array.ignore_nan_and_function_1 import ignore_nan_and_function_1
from .array.ignore_nan_and_function_2 import ignore_nan_and_function_2
from .array.is_sorted import is_sorted
...
# from .information.get_ic import get_ic
# from .information.get_icd import get_icd
# from .information.get_jsd import get_jsd
# from .information.get_kld import get_kld
# from .information.get_zd import get_zd
