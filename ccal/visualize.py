...
CMAP_CATEGORICAL = sns.palplot(sns.color_palette(
    [BLACK, GRAY, SILVER, WHITE, MAROON, RED, RED_ORANGE, ORANGE, GOLD, YELLOW, GREEN, LIGHT_GREEN, LIME_GREEN, TEAL,
     AQUA, LIGHT_BLUE, BLUE, NAVY, LIGHT_PURPLE, PURPLE, LIGHT_PINK, PINK, HOT_PINK, RED_VIOLET]))
