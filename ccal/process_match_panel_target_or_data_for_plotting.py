...
def process_match_panel_target_or_data_for_plotting(target_or_data, type, plot_std):
    ...
    if type == "continuous":
        ...
        if type == "categorical":
            ...
            colorscale = make_colorscale_from_colors(colors=COLOR_CATEGORICAL[:n_color])

        elif type == "binary":

            colorscale = make_colorscale_from_colors(colors=COLOR_WHITE_BLACK)
